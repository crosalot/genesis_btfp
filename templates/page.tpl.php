  ...
  <?php if (!$in_overlay): // hide in overlay ?>
    ...
    <?php if ($main_menu_links): ?>
      <div id="main-menu-wrapper">
         <div class="main-menu-inner container clearfix"><?php print $main_menu_links; ?></div>
      </div>
    <?php endif; ?>
	    ...
	    <div id="content-column" class="clearfix">
	      <div class="content-inner">
			...
			<?php if ($page['sidebar_first']): ?>
			   <div id="sidebar-first" class="sidebar" role="complimentary"><?php print render($page['sidebar_first']); ?></div>
			<?php endif; ?>
			
			<?php if ($page['sidebar_second']): ?>
			   <div id="sidebar-second" class="sidebar" role="complimentary"><?php print render($page['sidebar_second']); ?></div>
			<?php endif; ?>
